...
# Write to csv
write_alpha_history_to_csvs(alpha_history=alpha_normal_history, alpha=alpha_normal, type="normal")
write_alpha_history_to_csvs(alpha_history=alpha_normal_history, alpha=alpha_normal, type="reduce")